...
public static unsafe partial class Vulkan
{
	private static void LoadCommands(VkInstance instance, LoadFunction load)
	{
		...
		vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI_ptr = (delegate* unmanaged<VkDevice, VkRenderPass, Vector2ui*, VkResult>)load(instance, nameof(vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI));
		...
		vkCmdDrawMultiEXT_ptr = (delegate* unmanaged<VkCommandBuffer, uint, VkMultiDrawInfoEXT*, uint, uint, uint, void>)load(instance, nameof(vkCmdDrawMultiEXT));
		vkCmdDrawMultiIndexedEXT_ptr = (delegate* unmanaged<VkCommandBuffer, uint, VkMultiDrawIndexedInfoEXT*, uint, uint, uint, int*, void>)load(instance, nameof(vkCmdDrawMultiIndexedEXT));
		...
		vkCmdSubpassShadingHUAWEI_ptr = (delegate* unmanaged<VkCommandBuffer, void>)load(instance, nameof(vkCmdSubpassShadingHUAWEI));
		...
		vkGetMemoryRemoteAddressNV_ptr = (delegate* unmanaged<VkDevice, VkMemoryGetRemoteAddressInfoNV*, IntPtr*, VkResult>)load(instance, nameof(vkGetMemoryRemoteAddressNV));
		...
		vkGetDeviceBufferMemoryRequirements_ptr = (delegate* unmanaged<VkDevice, VkDeviceBufferMemoryRequirements*, VkMemoryRequirements2*, void>)load(instance, nameof(vkGetDeviceBufferMemoryRequirements));
		vkGetDeviceImageMemoryRequirements_ptr = (delegate* unmanaged<VkDevice, VkDeviceImageMemoryRequirements*, VkMemoryRequirements2*, void>)load(instance, nameof(vkGetDeviceImageMemoryRequirements));
		vkGetDeviceImageSparseMemoryRequirements_ptr = (delegate* unmanaged<VkDevice, VkDeviceImageMemoryRequirements*, uint*, VkSparseImageMemoryRequirements2*, void>)load(instance, nameof(vkGetDeviceImageSparseMemoryRequirements));
		...
		vkCmdBindInvocationMaskHUAWEI_ptr = (delegate* unmanaged<VkCommandBuffer, VkImageView, VkImageLayout, void>)load(instance, nameof(vkCmdBindInvocationMaskHUAWEI));
		...
		vkGetPhysicalDeviceToolProperties_ptr = (delegate* unmanaged<VkPhysicalDevice, uint*, VkPhysicalDeviceToolProperties*, VkResult>)load(instance, nameof(vkGetPhysicalDeviceToolProperties));
		...
		vkCmdSetCullMode_ptr = (delegate* unmanaged<VkCommandBuffer, VkCullModeFlags, void>)load(instance, nameof(vkCmdSetCullMode));
		vkCmdSetFrontFace_ptr = (delegate* unmanaged<VkCommandBuffer, VkFrontFace, void>)load(instance, nameof(vkCmdSetFrontFace));
		vkCmdSetPrimitiveTopology_ptr = (delegate* unmanaged<VkCommandBuffer, VkPrimitiveTopology, void>)load(instance, nameof(vkCmdSetPrimitiveTopology));
		vkCmdSetViewportWithCount_ptr = (delegate* unmanaged<VkCommandBuffer, uint, VkViewport*, void>)load(instance, nameof(vkCmdSetViewportWithCount));
		vkCmdSetScissorWithCount_ptr = (delegate* unmanaged<VkCommandBuffer, uint, VkRect2D*, void>)load(instance, nameof(vkCmdSetScissorWithCount));
		vkCmdBindVertexBuffers2_ptr = (delegate* unmanaged<VkCommandBuffer, uint, uint, VkBuffer*, ulong*, ulong*, ulong*, void>)load(instance, nameof(vkCmdBindVertexBuffers2));
		vkCmdSetDepthTestEnable_ptr = (delegate* unmanaged<VkCommandBuffer, VkBool32, void>)load(instance, nameof(vkCmdSetDepthTestEnable));
		vkCmdSetDepthWriteEnable_ptr = (delegate* unmanaged<VkCommandBuffer, VkBool32, void>)load(instance, nameof(vkCmdSetDepthWriteEnable));
		vkCmdSetDepthCompareOp_ptr = (delegate* unmanaged<VkCommandBuffer, VkCompareOp, void>)load(instance, nameof(vkCmdSetDepthCompareOp));
		vkCmdSetDepthBoundsTestEnable_ptr = (delegate* unmanaged<VkCommandBuffer, VkBool32, void>)load(instance, nameof(vkCmdSetDepthBoundsTestEnable));
		vkCmdSetStencilTestEnable_ptr = (delegate* unmanaged<VkCommandBuffer, VkBool32, void>)load(instance, nameof(vkCmdSetStencilTestEnable));
		vkCmdSetStencilOp_ptr = (delegate* unmanaged<VkCommandBuffer, VkStencilFaceFlags, VkStencilOp, VkStencilOp, VkStencilOp, VkCompareOp, void>)load(instance, nameof(vkCmdSetStencilOp));
		vkCmdSetPatchControlPointsEXT_ptr = (delegate* unmanaged<VkCommandBuffer, uint, void>)load(instance, nameof(vkCmdSetPatchControlPointsEXT));
		vkCmdSetRasterizerDiscardEnable_ptr = (delegate* unmanaged<VkCommandBuffer, VkBool32, void>)load(instance, nameof(vkCmdSetRasterizerDiscardEnable));
		vkCmdSetDepthBiasEnable_ptr = (delegate* unmanaged<VkCommandBuffer, VkBool32, void>)load(instance, nameof(vkCmdSetDepthBiasEnable));
		vkCmdSetLogicOpEXT_ptr = (delegate* unmanaged<VkCommandBuffer, VkLogicOp, void>)load(instance, nameof(vkCmdSetLogicOpEXT));
		vkCmdSetPrimitiveRestartEnable_ptr = (delegate* unmanaged<VkCommandBuffer, VkBool32, void>)load(instance, nameof(vkCmdSetPrimitiveRestartEnable));
		vkCreatePrivateDataSlot_ptr = (delegate* unmanaged<VkDevice, VkPrivateDataSlotCreateInfo*, VkAllocationCallbacks*, VkPrivateDataSlot*, VkResult>)load(instance, nameof(vkCreatePrivateDataSlot));
		vkDestroyPrivateDataSlot_ptr = (delegate* unmanaged<VkDevice, VkPrivateDataSlot, VkAllocationCallbacks*, void>)load(instance, nameof(vkDestroyPrivateDataSlot));
		vkSetPrivateData_ptr = (delegate* unmanaged<VkDevice, VkObjectType, ulong, VkPrivateDataSlot, ulong, VkResult>)load(instance, nameof(vkSetPrivateData));
		vkGetPrivateData_ptr = (delegate* unmanaged<VkDevice, VkObjectType, ulong, VkPrivateDataSlot, ulong*, void>)load(instance, nameof(vkGetPrivateData));
		vkCmdCopyBuffer2_ptr = (delegate* unmanaged<VkCommandBuffer, VkCopyBufferInfo2*, void>)load(instance, nameof(vkCmdCopyBuffer2));
		vkCmdCopyImage2_ptr = (delegate* unmanaged<VkCommandBuffer, VkCopyImageInfo2*, void>)load(instance, nameof(vkCmdCopyImage2));
		vkCmdBlitImage2_ptr = (delegate* unmanaged<VkCommandBuffer, VkBlitImageInfo2*, void>)load(instance, nameof(vkCmdBlitImage2));
		vkCmdCopyBufferToImage2_ptr = (delegate* unmanaged<VkCommandBuffer, VkCopyBufferToImageInfo2*, void>)load(instance, nameof(vkCmdCopyBufferToImage2));
		vkCmdCopyImageToBuffer2_ptr = (delegate* unmanaged<VkCommandBuffer, VkCopyImageToBufferInfo2*, void>)load(instance, nameof(vkCmdCopyImageToBuffer2));
		vkCmdResolveImage2_ptr = (delegate* unmanaged<VkCommandBuffer, VkResolveImageInfo2*, void>)load(instance, nameof(vkCmdResolveImage2));
		...
		vkCmdSetVertexInputEXT_ptr = (delegate* unmanaged<VkCommandBuffer, uint, VkVertexInputBindingDescription2EXT*, uint, VkVertexInputAttributeDescription2EXT*, void>)load(instance, nameof(vkCmdSetVertexInputEXT));
		vkCmdSetColorWriteEnableEXT_ptr = (delegate* unmanaged<VkCommandBuffer, uint, VkBool32*, void>)load(instance, nameof(vkCmdSetColorWriteEnableEXT));
		vkCmdSetEvent2_ptr = (delegate* unmanaged<VkCommandBuffer, VkEvent, VkDependencyInfo*, void>)load(instance, nameof(vkCmdSetEvent2));
		vkCmdResetEvent2_ptr = (delegate* unmanaged<VkCommandBuffer, VkEvent, VkPipelineStageFlags2, void>)load(instance, nameof(vkCmdResetEvent2));
		vkCmdWaitEvents2_ptr = (delegate* unmanaged<VkCommandBuffer, uint, VkEvent*, VkDependencyInfo*, void>)load(instance, nameof(vkCmdWaitEvents2));
		vkCmdPipelineBarrier2_ptr = (delegate* unmanaged<VkCommandBuffer, VkDependencyInfo*, void>)load(instance, nameof(vkCmdPipelineBarrier2));
		vkQueueSubmit2_ptr = (delegate* unmanaged<VkQueue, uint, VkSubmitInfo2*, VkFence, VkResult>)load(instance, nameof(vkQueueSubmit2));
		vkCmdWriteTimestamp2_ptr = (delegate* unmanaged<VkCommandBuffer, VkPipelineStageFlags2, VkQueryPool, uint, void>)load(instance, nameof(vkCmdWriteTimestamp2));
		vkCmdWriteBufferMarker2AMD_ptr = (delegate* unmanaged<VkCommandBuffer, VkPipelineStageFlags2, VkBuffer, ulong, uint, void>)load(instance, nameof(vkCmdWriteBufferMarker2AMD));
		...
		vkGetPhysicalDeviceVideoCapabilitiesKHR_ptr = (delegate* unmanaged<VkPhysicalDevice, VkVideoProfileKHR*, VkVideoCapabilitiesKHR*, VkResult>)load(instance, nameof(vkGetPhysicalDeviceVideoCapabilitiesKHR));
		vkGetPhysicalDeviceVideoFormatPropertiesKHR_ptr = (delegate* unmanaged<VkPhysicalDevice, VkPhysicalDeviceVideoFormatInfoKHR*, uint*, VkVideoFormatPropertiesKHR*, VkResult>)load(instance, nameof(vkGetPhysicalDeviceVideoFormatPropertiesKHR));
		vkCreateVideoSessionKHR_ptr = (delegate* unmanaged<VkDevice, VkVideoSessionCreateInfoKHR*, VkAllocationCallbacks*, VkVideoSessionKHR*, VkResult>)load(instance, nameof(vkCreateVideoSessionKHR));
		vkDestroyVideoSessionKHR_ptr = (delegate* unmanaged<VkDevice, VkVideoSessionKHR, VkAllocationCallbacks*, void>)load(instance, nameof(vkDestroyVideoSessionKHR));
		vkCreateVideoSessionParametersKHR_ptr = (delegate* unmanaged<VkDevice, VkVideoSessionParametersCreateInfoKHR*, VkAllocationCallbacks*, VkVideoSessionParametersKHR*, VkResult>)load(instance, nameof(vkCreateVideoSessionParametersKHR));
		vkUpdateVideoSessionParametersKHR_ptr = (delegate* unmanaged<VkDevice, VkVideoSessionParametersKHR, VkVideoSessionParametersUpdateInfoKHR*, VkResult>)load(instance, nameof(vkUpdateVideoSessionParametersKHR));
		vkDestroyVideoSessionParametersKHR_ptr = (delegate* unmanaged<VkDevice, VkVideoSessionParametersKHR, VkAllocationCallbacks*, void>)load(instance, nameof(vkDestroyVideoSessionParametersKHR));
		vkGetVideoSessionMemoryRequirementsKHR_ptr = (delegate* unmanaged<VkDevice, VkVideoSessionKHR, uint*, VkVideoGetMemoryPropertiesKHR*, VkResult>)load(instance, nameof(vkGetVideoSessionMemoryRequirementsKHR));
		vkBindVideoSessionMemoryKHR_ptr = (delegate* unmanaged<VkDevice, VkVideoSessionKHR, uint, VkVideoBindMemoryKHR*, VkResult>)load(instance, nameof(vkBindVideoSessionMemoryKHR));
		vkCmdDecodeVideoKHR_ptr = (delegate* unmanaged<VkCommandBuffer, VkVideoDecodeInfoKHR*, void>)load(instance, nameof(vkCmdDecodeVideoKHR));
		vkCmdBeginVideoCodingKHR_ptr = (delegate* unmanaged<VkCommandBuffer, VkVideoBeginCodingInfoKHR*, void>)load(instance, nameof(vkCmdBeginVideoCodingKHR));
		vkCmdControlVideoCodingKHR_ptr = (delegate* unmanaged<VkCommandBuffer, VkVideoCodingControlInfoKHR*, void>)load(instance, nameof(vkCmdControlVideoCodingKHR));
		vkCmdEndVideoCodingKHR_ptr = (delegate* unmanaged<VkCommandBuffer, VkVideoEndCodingInfoKHR*, void>)load(instance, nameof(vkCmdEndVideoCodingKHR));
		vkCmdEncodeVideoKHR_ptr = (delegate* unmanaged<VkCommandBuffer, VkVideoEncodeInfoKHR*, void>)load(instance, nameof(vkCmdEncodeVideoKHR));
		vkCreateCuModuleNVX_ptr = (delegate* unmanaged<VkDevice, VkCuModuleCreateInfoNVX*, VkAllocationCallbacks*, VkCuModuleNVX*, VkResult>)load(instance, nameof(vkCreateCuModuleNVX));
		vkCreateCuFunctionNVX_ptr = (delegate* unmanaged<VkDevice, VkCuFunctionCreateInfoNVX*, VkAllocationCallbacks*, VkCuFunctionNVX*, VkResult>)load(instance, nameof(vkCreateCuFunctionNVX));
		vkDestroyCuModuleNVX_ptr = (delegate* unmanaged<VkDevice, VkCuModuleNVX, VkAllocationCallbacks*, void>)load(instance, nameof(vkDestroyCuModuleNVX));
		vkDestroyCuFunctionNVX_ptr = (delegate* unmanaged<VkDevice, VkCuFunctionNVX, VkAllocationCallbacks*, void>)load(instance, nameof(vkDestroyCuFunctionNVX));
		vkCmdCuLaunchKernelNVX_ptr = (delegate* unmanaged<VkCommandBuffer, VkCuLaunchInfoNVX*, void>)load(instance, nameof(vkCmdCuLaunchKernelNVX));
		vkSetDeviceMemoryPriorityEXT_ptr = (delegate* unmanaged<VkDevice, VkDeviceMemory, float, void>)load(instance, nameof(vkSetDeviceMemoryPriorityEXT));
		vkAcquireDrmDisplayEXT_ptr = (delegate* unmanaged<VkPhysicalDevice, int, VkDisplayKHR, VkResult>)load(instance, nameof(vkAcquireDrmDisplayEXT));
		vkGetDrmDisplayEXT_ptr = (delegate* unmanaged<VkPhysicalDevice, int, uint, VkDisplayKHR, VkResult>)load(instance, nameof(vkGetDrmDisplayEXT));
		vkWaitForPresentKHR_ptr = (delegate* unmanaged<VkDevice, VkSwapchainKHR, ulong, ulong, VkResult>)load(instance, nameof(vkWaitForPresentKHR));
		vkCreateBufferCollectionFUCHSIA_ptr = (delegate* unmanaged<VkDevice, VkBufferCollectionCreateInfoFUCHSIA*, VkAllocationCallbacks*, VkBufferCollectionFUCHSIA*, VkResult>)load(instance, nameof(vkCreateBufferCollectionFUCHSIA));
		vkSetBufferCollectionBufferConstraintsFUCHSIA_ptr = (delegate* unmanaged<VkDevice, VkBufferCollectionFUCHSIA, VkBufferConstraintsInfoFUCHSIA*, VkResult>)load(instance, nameof(vkSetBufferCollectionBufferConstraintsFUCHSIA));
		vkSetBufferCollectionImageConstraintsFUCHSIA_ptr = (delegate* unmanaged<VkDevice, VkBufferCollectionFUCHSIA, VkImageConstraintsInfoFUCHSIA*, VkResult>)load(instance, nameof(vkSetBufferCollectionImageConstraintsFUCHSIA));
		vkDestroyBufferCollectionFUCHSIA_ptr = (delegate* unmanaged<VkDevice, VkBufferCollectionFUCHSIA, VkAllocationCallbacks*, void>)load(instance, nameof(vkDestroyBufferCollectionFUCHSIA));
		vkGetBufferCollectionPropertiesFUCHSIA_ptr = (delegate* unmanaged<VkDevice, VkBufferCollectionFUCHSIA, VkBufferCollectionPropertiesFUCHSIA*, VkResult>)load(instance, nameof(vkGetBufferCollectionPropertiesFUCHSIA));
		vkCmdBeginRendering_ptr = (delegate* unmanaged<VkCommandBuffer, VkRenderingInfo*, void>)load(instance, nameof(vkCmdBeginRendering));
		vkCmdEndRendering_ptr = (delegate* unmanaged<VkCommandBuffer, void>)load(instance, nameof(vkCmdEndRendering));
		vkGetDescriptorSetLayoutHostMappingInfoVALVE_ptr = (delegate* unmanaged<VkDevice, VkDescriptorSetBindingReferenceVALVE*, VkDescriptorSetLayoutHostMappingInfoVALVE*, void>)load(instance, nameof(vkGetDescriptorSetLayoutHostMappingInfoVALVE));
		vkGetDescriptorSetHostMappingVALVE_ptr = (delegate* unmanaged<VkDevice, VkDescriptorSet, void**, void>)load(instance, nameof(vkGetDescriptorSetHostMappingVALVE));
	}
}
