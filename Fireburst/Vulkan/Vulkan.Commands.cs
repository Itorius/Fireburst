...
public static unsafe partial class Vulkan
{
	...
	internal static delegate* unmanaged<VkDevice, VkRenderPass, Vector2ui*, VkResult> vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI_ptr;

	public static VkResult vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI(VkDevice device, VkRenderPass renderpass, Vector2ui* pMaxWorkgroupSize)
	{
		return vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI_ptr(device, renderpass, pMaxWorkgroupSize);
	}
	...
	internal static delegate* unmanaged<VkCommandBuffer, uint, VkMultiDrawInfoEXT*, uint, uint, uint, void> vkCmdDrawMultiEXT_ptr;

	public static void vkCmdDrawMultiEXT(VkCommandBuffer commandBuffer, VkMultiDrawInfoEXT* pVertexInfo, uint instanceCount, uint firstInstance, uint stride, uint drawCount = default)
	{
		vkCmdDrawMultiEXT_ptr(commandBuffer, drawCount, pVertexInfo, instanceCount, firstInstance, stride);
	}

	internal static delegate* unmanaged<VkCommandBuffer, uint, VkMultiDrawIndexedInfoEXT*, uint, uint, uint, int*, void> vkCmdDrawMultiIndexedEXT_ptr;

	public static void vkCmdDrawMultiIndexedEXT(VkCommandBuffer commandBuffer, VkMultiDrawIndexedInfoEXT* pIndexInfo, uint instanceCount, uint firstInstance, uint stride, uint drawCount = default, int* pVertexOffset = default)
	{
	...
	internal static delegate* unmanaged<VkCommandBuffer, void> vkCmdSubpassShadingHUAWEI_ptr;
	...
	public static void vkCmdSetEvent(VkCommandBuffer commandBuffer, VkEvent @event, VkPipelineStageFlags stageMask = default)
	{
	...
	public static void vkCmdResetEvent(VkCommandBuffer commandBuffer, VkEvent @event, VkPipelineStageFlags stageMask = default)
	{
	...
	public static void vkCmdPipelineBarrier(VkCommandBuffer commandBuffer, VkMemoryBarrier* pMemoryBarriers, VkBufferMemoryBarrier* pBufferMemoryBarriers, VkImageMemoryBarrier* pImageMemoryBarriers, VkPipelineStageFlags srcStageMask = default, VkPipelineStageFlags dstStageMask = default, VkDependencyFlags dependencyFlags = default, uint memoryBarrierCount = default, uint bufferMemoryBarrierCount = default, uint imageMemoryBarrierCount = default)
	{
	...
	public static VkResult vkGetPhysicalDeviceSurfaceFormatsKHR(VkPhysicalDevice physicalDevice, uint* pSurfaceFormatCount, VkSurfaceKHR surface = default, VkSurfaceFormatKHR* pSurfaceFormats = default)
	{
	...
	public static VkResult vkGetPhysicalDeviceSurfacePresentModesKHR(VkPhysicalDevice physicalDevice, uint* pPresentModeCount, VkSurfaceKHR surface = default, VkPresentModeKHR* pPresentModes = default)
	{
	...
	internal static delegate* unmanaged<VkDevice, VkMemoryGetRemoteAddressInfoNV*, IntPtr*, VkResult> vkGetMemoryRemoteAddressNV_ptr;

	public static VkResult vkGetMemoryRemoteAddressNV(VkDevice device, VkMemoryGetRemoteAddressInfoNV* pMemoryGetRemoteAddressInfo, IntPtr* pAddress)
	{
		return vkGetMemoryRemoteAddressNV_ptr(device, pMemoryGetRemoteAddressInfo, pAddress);
	}
	...
	internal static delegate* unmanaged<VkDevice, VkDeviceImageMemoryRequirements*, uint*, VkSparseImageMemoryRequirements2*, void> vkGetDeviceImageSparseMemoryRequirements_ptr;

	public static void vkGetDeviceImageSparseMemoryRequirements(VkDevice device, VkDeviceImageMemoryRequirements* pInfo, uint* pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2* pSparseMemoryRequirements = default)
	{
	...
	public static void vkCmdWriteBufferMarkerAMD(VkCommandBuffer commandBuffer, VkBuffer dstBuffer, ulong dstOffset, uint marker, VkPipelineStageFlags pipelineStage = default)
	{
	...
	internal static delegate* unmanaged<VkCommandBuffer, VkImageView, VkImageLayout, void> vkCmdBindInvocationMaskHUAWEI_ptr;

	public static void vkCmdBindInvocationMaskHUAWEI(VkCommandBuffer commandBuffer, VkImageLayout imageLayout, VkImageView imageView = default)
	{
	...
	internal static delegate* unmanaged<VkPhysicalDevice, uint*, VkPhysicalDeviceToolProperties*, VkResult> vkGetPhysicalDeviceToolProperties_ptr;

	public static VkResult vkGetPhysicalDeviceToolProperties(VkPhysicalDevice physicalDevice, uint* pToolCount, VkPhysicalDeviceToolProperties* pToolProperties = default)
	{
		return vkGetPhysicalDeviceToolProperties_ptr(physicalDevice, pToolCount, pToolProperties);
	}
	...
	internal static delegate* unmanaged<VkCommandBuffer, VkCullModeFlags, void> vkCmdSetCullMode_ptr;

	public static void vkCmdSetCullMode(VkCommandBuffer commandBuffer, VkCullModeFlags cullMode = default)
	{
		vkCmdSetCullMode_ptr(commandBuffer, cullMode);
	}

	internal static delegate* unmanaged<VkCommandBuffer, VkFrontFace, void> vkCmdSetFrontFace_ptr;
	...
	internal static delegate* unmanaged<VkCommandBuffer, VkPrimitiveTopology, void> vkCmdSetPrimitiveTopology_ptr;
	...
	internal static delegate* unmanaged<VkCommandBuffer, uint, VkViewport*, void> vkCmdSetViewportWithCount_ptr;
	...
	internal static delegate* unmanaged<VkCommandBuffer, uint, VkRect2D*, void> vkCmdSetScissorWithCount_ptr;
	...
	internal static delegate* unmanaged<VkCommandBuffer, uint, uint, VkBuffer*, ulong*, ulong*, ulong*, void> vkCmdBindVertexBuffers2_ptr;

	public static void vkCmdBindVertexBuffers2(VkCommandBuffer commandBuffer, uint firstBinding, uint bindingCount, VkBuffer* pBuffers, ulong* pOffsets, ulong* pSizes = default, ulong* pStrides = default)
	{
		vkCmdBindVertexBuffers2_ptr(commandBuffer, firstBinding, bindingCount, pBuffers, pOffsets, pSizes, pStrides);
	}

	internal static delegate* unmanaged<VkCommandBuffer, VkBool32, void> vkCmdSetDepthTestEnable_ptr;
	...
	internal static delegate* unmanaged<VkCommandBuffer, VkBool32, void> vkCmdSetDepthWriteEnable_ptr;
	...
	internal static delegate* unmanaged<VkCommandBuffer, VkCompareOp, void> vkCmdSetDepthCompareOp_ptr;
	...
	internal static delegate* unmanaged<VkCommandBuffer, VkBool32, void> vkCmdSetDepthBoundsTestEnable_ptr;
	...
	internal static delegate* unmanaged<VkCommandBuffer, VkBool32, void> vkCmdSetStencilTestEnable_ptr;
	...
	internal static delegate* unmanaged<VkCommandBuffer, VkStencilFaceFlags, VkStencilOp, VkStencilOp, VkStencilOp, VkCompareOp, void> vkCmdSetStencilOp_ptr;
	...
	internal static delegate* unmanaged<VkCommandBuffer, uint, void> vkCmdSetPatchControlPointsEXT_ptr;
	...
	internal static delegate* unmanaged<VkCommandBuffer, VkBool32, void> vkCmdSetRasterizerDiscardEnable_ptr;
	...
	internal static delegate* unmanaged<VkCommandBuffer, VkBool32, void> vkCmdSetDepthBiasEnable_ptr;
	...
	internal static delegate* unmanaged<VkCommandBuffer, VkLogicOp, void> vkCmdSetLogicOpEXT_ptr;
	...
	internal static delegate* unmanaged<VkCommandBuffer, VkBool32, void> vkCmdSetPrimitiveRestartEnable_ptr;
	...
	internal static delegate* unmanaged<VkDevice, VkPrivateDataSlotCreateInfo*, VkAllocationCallbacks*, VkPrivateDataSlot*, VkResult> vkCreatePrivateDataSlot_ptr;

	public static VkResult vkCreatePrivateDataSlot(VkDevice device, VkPrivateDataSlotCreateInfo pCreateInfo, VkPrivateDataSlot* pPrivateDataSlot, VkAllocationCallbacks* pAllocator = default)
	{
		return vkCreatePrivateDataSlot_ptr(device, &pCreateInfo, pAllocator, pPrivateDataSlot);
	}

	internal static delegate* unmanaged<VkDevice, VkPrivateDataSlot, VkAllocationCallbacks*, void> vkDestroyPrivateDataSlot_ptr;

	public static void vkDestroyPrivateDataSlot(VkDevice device, VkPrivateDataSlot privateDataSlot = default, VkAllocationCallbacks* pAllocator = default)
	{
		vkDestroyPrivateDataSlot_ptr(device, privateDataSlot, pAllocator);
	}

	internal static delegate* unmanaged<VkDevice, VkObjectType, ulong, VkPrivateDataSlot, ulong, VkResult> vkSetPrivateData_ptr;
	...
	internal static delegate* unmanaged<VkDevice, VkObjectType, ulong, VkPrivateDataSlot, ulong*, void> vkGetPrivateData_ptr;
	...
	internal static delegate* unmanaged<VkCommandBuffer, VkCopyBufferInfo2*, void> vkCmdCopyBuffer2_ptr;
	...
	internal static delegate* unmanaged<VkCommandBuffer, VkCopyImageInfo2*, void> vkCmdCopyImage2_ptr;
	...
	internal static delegate* unmanaged<VkCommandBuffer, VkBlitImageInfo2*, void> vkCmdBlitImage2_ptr;
	...
	internal static delegate* unmanaged<VkCommandBuffer, VkCopyBufferToImageInfo2*, void> vkCmdCopyBufferToImage2_ptr;
	...
	internal static delegate* unmanaged<VkCommandBuffer, VkCopyImageToBufferInfo2*, void> vkCmdCopyImageToBuffer2_ptr;
	...
	internal static delegate* unmanaged<VkCommandBuffer, VkResolveImageInfo2*, void> vkCmdResolveImage2_ptr;
	...
	internal static delegate* unmanaged<VkCommandBuffer, uint, VkVertexInputBindingDescription2EXT*, uint, VkVertexInputAttributeDescription2EXT*, void> vkCmdSetVertexInputEXT_ptr;

	public static void vkCmdSetVertexInputEXT(VkCommandBuffer commandBuffer, VkVertexInputBindingDescription2EXT* pVertexBindingDescriptions, VkVertexInputAttributeDescription2EXT* pVertexAttributeDescriptions, uint vertexBindingDescriptionCount = default, uint vertexAttributeDescriptionCount = default)
	{
	...
	internal static delegate* unmanaged<VkCommandBuffer, uint, VkBool32*, void> vkCmdSetColorWriteEnableEXT_ptr;
	...
	internal static delegate* unmanaged<VkCommandBuffer, VkEvent, VkDependencyInfo*, void> vkCmdSetEvent2_ptr;
	...
	internal static delegate* unmanaged<VkCommandBuffer, VkEvent, VkPipelineStageFlags2, void> vkCmdResetEvent2_ptr;

	public static void vkCmdResetEvent2(VkCommandBuffer commandBuffer, VkEvent @event, VkPipelineStageFlags2 stageMask = default)
	{
		vkCmdResetEvent2_ptr(commandBuffer, @event, stageMask);
	}

	internal static delegate* unmanaged<VkCommandBuffer, uint, VkEvent*, VkDependencyInfo*, void> vkCmdWaitEvents2_ptr;
	...
	internal static delegate* unmanaged<VkCommandBuffer, VkDependencyInfo*, void> vkCmdPipelineBarrier2_ptr;
	...
	internal static delegate* unmanaged<VkQueue, uint, VkSubmitInfo2*, VkFence, VkResult> vkQueueSubmit2_ptr;

	public static VkResult vkQueueSubmit2(VkQueue queue, VkSubmitInfo2* pSubmits, uint submitCount = default, VkFence fence = default)
	{
		return vkQueueSubmit2_ptr(queue, submitCount, pSubmits, fence);
	}

	internal static delegate* unmanaged<VkCommandBuffer, VkPipelineStageFlags2, VkQueryPool, uint, void> vkCmdWriteTimestamp2_ptr;

	public static void vkCmdWriteTimestamp2(VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint query, VkPipelineStageFlags2 stage = default)
	{
		vkCmdWriteTimestamp2_ptr(commandBuffer, stage, queryPool, query);
	}

	internal static delegate* unmanaged<VkCommandBuffer, VkPipelineStageFlags2, VkBuffer, ulong, uint, void> vkCmdWriteBufferMarker2AMD_ptr;

	public static void vkCmdWriteBufferMarker2AMD(VkCommandBuffer commandBuffer, VkBuffer dstBuffer, ulong dstOffset, uint marker, VkPipelineStageFlags2 stage = default)
	{
	...
	internal static delegate* unmanaged<VkPhysicalDevice, VkVideoProfileKHR*, VkVideoCapabilitiesKHR*, VkResult> vkGetPhysicalDeviceVideoCapabilitiesKHR_ptr;
	...
	{
		return vkGetPhysicalDeviceVideoCapabilitiesKHR_ptr(physicalDevice, pVideoProfile, pCapabilities);
	}

	internal static delegate* unmanaged<VkPhysicalDevice, VkPhysicalDeviceVideoFormatInfoKHR*, uint*, VkVideoFormatPropertiesKHR*, VkResult> vkGetPhysicalDeviceVideoFormatPropertiesKHR_ptr;

	public static VkResult vkGetPhysicalDeviceVideoFormatPropertiesKHR(VkPhysicalDevice physicalDevice, VkPhysicalDeviceVideoFormatInfoKHR* pVideoFormatInfo, uint* pVideoFormatPropertyCount, VkVideoFormatPropertiesKHR* pVideoFormatProperties = default)
	{
		return vkGetPhysicalDeviceVideoFormatPropertiesKHR_ptr(physicalDevice, pVideoFormatInfo, pVideoFormatPropertyCount, pVideoFormatProperties);
	}

	internal static delegate* unmanaged<VkDevice, VkVideoSessionCreateInfoKHR*, VkAllocationCallbacks*, VkVideoSessionKHR*, VkResult> vkCreateVideoSessionKHR_ptr;

	public static VkResult vkCreateVideoSessionKHR(VkDevice device, VkVideoSessionCreateInfoKHR pCreateInfo, VkVideoSessionKHR* pVideoSession, VkAllocationCallbacks* pAllocator = default)
	{
		return vkCreateVideoSessionKHR_ptr(device, &pCreateInfo, pAllocator, pVideoSession);
	}

	internal static delegate* unmanaged<VkDevice, VkVideoSessionKHR, VkAllocationCallbacks*, void> vkDestroyVideoSessionKHR_ptr;

	public static void vkDestroyVideoSessionKHR(VkDevice device, VkVideoSessionKHR videoSession, VkAllocationCallbacks* pAllocator = default)
	{
		vkDestroyVideoSessionKHR_ptr(device, videoSession, pAllocator);
	}

	internal static delegate* unmanaged<VkDevice, VkVideoSessionParametersCreateInfoKHR*, VkAllocationCallbacks*, VkVideoSessionParametersKHR*, VkResult> vkCreateVideoSessionParametersKHR_ptr;

	public static VkResult vkCreateVideoSessionParametersKHR(VkDevice device, VkVideoSessionParametersCreateInfoKHR pCreateInfo, VkVideoSessionParametersKHR* pVideoSessionParameters, VkAllocationCallbacks* pAllocator = default)
	{
		return vkCreateVideoSessionParametersKHR_ptr(device, &pCreateInfo, pAllocator, pVideoSessionParameters);
	}

	internal static delegate* unmanaged<VkDevice, VkVideoSessionParametersKHR, VkVideoSessionParametersUpdateInfoKHR*, VkResult> vkUpdateVideoSessionParametersKHR_ptr;
	...
	{
		return vkUpdateVideoSessionParametersKHR_ptr(device, videoSessionParameters, pUpdateInfo);
	}

	internal static delegate* unmanaged<VkDevice, VkVideoSessionParametersKHR, VkAllocationCallbacks*, void> vkDestroyVideoSessionParametersKHR_ptr;

	public static void vkDestroyVideoSessionParametersKHR(VkDevice device, VkVideoSessionParametersKHR videoSessionParameters, VkAllocationCallbacks* pAllocator = default)
	{
		vkDestroyVideoSessionParametersKHR_ptr(device, videoSessionParameters, pAllocator);
	}

	internal static delegate* unmanaged<VkDevice, VkVideoSessionKHR, uint*, VkVideoGetMemoryPropertiesKHR*, VkResult> vkGetVideoSessionMemoryRequirementsKHR_ptr;

	public static VkResult vkGetVideoSessionMemoryRequirementsKHR(VkDevice device, VkVideoSessionKHR videoSession, uint* pVideoSessionMemoryRequirementsCount, VkVideoGetMemoryPropertiesKHR* pVideoSessionMemoryRequirements = default)
	{
		return vkGetVideoSessionMemoryRequirementsKHR_ptr(device, videoSession, pVideoSessionMemoryRequirementsCount, pVideoSessionMemoryRequirements);
	}

	internal static delegate* unmanaged<VkDevice, VkVideoSessionKHR, uint, VkVideoBindMemoryKHR*, VkResult> vkBindVideoSessionMemoryKHR_ptr;
	...
	{
		return vkBindVideoSessionMemoryKHR_ptr(device, videoSession, videoSessionBindMemoryCount, pVideoSessionBindMemories);
	}

	internal static delegate* unmanaged<VkCommandBuffer, VkVideoDecodeInfoKHR*, void> vkCmdDecodeVideoKHR_ptr;
	...
	internal static delegate* unmanaged<VkCommandBuffer, VkVideoBeginCodingInfoKHR*, void> vkCmdBeginVideoCodingKHR_ptr;
	...
	internal static delegate* unmanaged<VkCommandBuffer, VkVideoCodingControlInfoKHR*, void> vkCmdControlVideoCodingKHR_ptr;
	...
	internal static delegate* unmanaged<VkCommandBuffer, VkVideoEndCodingInfoKHR*, void> vkCmdEndVideoCodingKHR_ptr;
	...
	internal static delegate* unmanaged<VkCommandBuffer, VkVideoEncodeInfoKHR*, void> vkCmdEncodeVideoKHR_ptr;
	...
	internal static delegate* unmanaged<VkDevice, VkCuModuleCreateInfoNVX*, VkAllocationCallbacks*, VkCuModuleNVX*, VkResult> vkCreateCuModuleNVX_ptr;

	public static VkResult vkCreateCuModuleNVX(VkDevice device, VkCuModuleCreateInfoNVX pCreateInfo, VkCuModuleNVX* pModule, VkAllocationCallbacks* pAllocator = default)
	{
		return vkCreateCuModuleNVX_ptr(device, &pCreateInfo, pAllocator, pModule);
	}

	internal static delegate* unmanaged<VkDevice, VkCuFunctionCreateInfoNVX*, VkAllocationCallbacks*, VkCuFunctionNVX*, VkResult> vkCreateCuFunctionNVX_ptr;

	public static VkResult vkCreateCuFunctionNVX(VkDevice device, VkCuFunctionCreateInfoNVX pCreateInfo, VkCuFunctionNVX* pFunction, VkAllocationCallbacks* pAllocator = default)
	{
		return vkCreateCuFunctionNVX_ptr(device, &pCreateInfo, pAllocator, pFunction);
	}

	internal static delegate* unmanaged<VkDevice, VkCuModuleNVX, VkAllocationCallbacks*, void> vkDestroyCuModuleNVX_ptr;

	public static void vkDestroyCuModuleNVX(VkDevice device, VkCuModuleNVX module, VkAllocationCallbacks* pAllocator = default)
	{
		vkDestroyCuModuleNVX_ptr(device, module, pAllocator);
	}

	internal static delegate* unmanaged<VkDevice, VkCuFunctionNVX, VkAllocationCallbacks*, void> vkDestroyCuFunctionNVX_ptr;

	public static void vkDestroyCuFunctionNVX(VkDevice device, VkCuFunctionNVX function, VkAllocationCallbacks* pAllocator = default)
	{
		vkDestroyCuFunctionNVX_ptr(device, function, pAllocator);
	}

	internal static delegate* unmanaged<VkCommandBuffer, VkCuLaunchInfoNVX*, void> vkCmdCuLaunchKernelNVX_ptr;
	...
	internal static delegate* unmanaged<VkDevice, VkDeviceMemory, float, void> vkSetDeviceMemoryPriorityEXT_ptr;
	...
	internal static delegate* unmanaged<VkPhysicalDevice, int, VkDisplayKHR, VkResult> vkAcquireDrmDisplayEXT_ptr;
	...
	internal static delegate* unmanaged<VkPhysicalDevice, int, uint, VkDisplayKHR, VkResult> vkGetDrmDisplayEXT_ptr;
	...
	internal static delegate* unmanaged<VkDevice, VkSwapchainKHR, ulong, ulong, VkResult> vkWaitForPresentKHR_ptr;
	...
	internal static delegate* unmanaged<VkDevice, VkBufferCollectionCreateInfoFUCHSIA*, VkAllocationCallbacks*, VkBufferCollectionFUCHSIA*, VkResult> vkCreateBufferCollectionFUCHSIA_ptr;

	public static VkResult vkCreateBufferCollectionFUCHSIA(VkDevice device, VkBufferCollectionCreateInfoFUCHSIA pCreateInfo, VkBufferCollectionFUCHSIA* pCollection, VkAllocationCallbacks* pAllocator = default)
	{
		return vkCreateBufferCollectionFUCHSIA_ptr(device, &pCreateInfo, pAllocator, pCollection);
	}

	internal static delegate* unmanaged<VkDevice, VkBufferCollectionFUCHSIA, VkBufferConstraintsInfoFUCHSIA*, VkResult> vkSetBufferCollectionBufferConstraintsFUCHSIA_ptr;
	...
	{
		return vkSetBufferCollectionBufferConstraintsFUCHSIA_ptr(device, collection, pBufferConstraintsInfo);
	}

	internal static delegate* unmanaged<VkDevice, VkBufferCollectionFUCHSIA, VkImageConstraintsInfoFUCHSIA*, VkResult> vkSetBufferCollectionImageConstraintsFUCHSIA_ptr;
	...
	{
		return vkSetBufferCollectionImageConstraintsFUCHSIA_ptr(device, collection, pImageConstraintsInfo);
	}

	internal static delegate* unmanaged<VkDevice, VkBufferCollectionFUCHSIA, VkAllocationCallbacks*, void> vkDestroyBufferCollectionFUCHSIA_ptr;

	public static void vkDestroyBufferCollectionFUCHSIA(VkDevice device, VkBufferCollectionFUCHSIA collection, VkAllocationCallbacks* pAllocator = default)
	{
		vkDestroyBufferCollectionFUCHSIA_ptr(device, collection, pAllocator);
	}

	internal static delegate* unmanaged<VkDevice, VkBufferCollectionFUCHSIA, VkBufferCollectionPropertiesFUCHSIA*, VkResult> vkGetBufferCollectionPropertiesFUCHSIA_ptr;
	...
	{
		return vkGetBufferCollectionPropertiesFUCHSIA_ptr(device, collection, pProperties);
	}

	internal static delegate* unmanaged<VkCommandBuffer, VkRenderingInfo*, void> vkCmdBeginRendering_ptr;
	...
	internal static delegate* unmanaged<VkCommandBuffer, void> vkCmdEndRendering_ptr;
	...
	internal static delegate* unmanaged<VkDevice, VkDescriptorSetBindingReferenceVALVE*, VkDescriptorSetLayoutHostMappingInfoVALVE*, void> vkGetDescriptorSetLayoutHostMappingInfoVALVE_ptr;
	...
	internal static delegate* unmanaged<VkDevice, VkDescriptorSet, void**, void> vkGetDescriptorSetHostMappingVALVE_ptr;
