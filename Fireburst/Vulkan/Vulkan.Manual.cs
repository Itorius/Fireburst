...
public static unsafe partial class Vulkan
{
	...
	public static ReadOnlySpan<VkSurfaceFormatKHR> vkGetPhysicalDeviceSurfaceFormatsKHR(VkPhysicalDevice physicalDevice, VkSurfaceKHR surface)
	{
		...
		vkGetPhysicalDeviceSurfaceFormatsKHR(physicalDevice, &surfaceFormatCount, surface, null).CheckResult();
		...
		{
			vkGetPhysicalDeviceSurfaceFormatsKHR(physicalDevice, &surfaceFormatCount, surface, surfaceFormatsPtr).CheckResult();
		}
	...
	public static ReadOnlySpan<VkPresentModeKHR> vkGetPhysicalDeviceSurfacePresentModesKHR(VkPhysicalDevice physicalDevice, VkSurfaceKHR surface)
	{
		...
		vkGetPhysicalDeviceSurfacePresentModesKHR(physicalDevice, &presentModeCount, surface, null).CheckResult();
		...
		{
			vkGetPhysicalDeviceSurfacePresentModesKHR(physicalDevice, &presentModeCount, surface, presentModesPtr).CheckResult();
		}
	...
	public static void vkCmdBindVertexBuffer(VkCommandBuffer commandBuffer, VkBuffer buffer, ulong* pOffsets)
	{
		vkCmdBindVertexBuffers_ptr(commandBuffer, 0, 1, &buffer, pOffsets);
	}
}
