...
public partial struct VkBufferCollectionFUCHSIA : IEquatable<VkBufferCollectionFUCHSIA>
{
	...
	public static VkBufferCollectionFUCHSIA Null => new(IntPtr.Zero);
	public static bool operator ==(VkBufferCollectionFUCHSIA left, VkBufferCollectionFUCHSIA right) => left.Handle == right.Handle;
	public static bool operator !=(VkBufferCollectionFUCHSIA left, VkBufferCollectionFUCHSIA right) => left.Handle != right.Handle;
	public bool Equals(ref VkBufferCollectionFUCHSIA other) => Handle == other.Handle;
	public bool Equals(VkBufferCollectionFUCHSIA other) => Handle == other.Handle;
	public override bool Equals(object obj) => obj is VkBufferCollectionFUCHSIA handle && Equals(ref handle);
	public override int GetHashCode() => Handle.GetHashCode();
	private string DebuggerDisplay => $"VkBufferCollectionFUCHSIA [0x{Handle:X}]";
}
...
public partial struct VkPrivateDataSlot : IEquatable<VkPrivateDataSlot>
{
	...
	public static VkPrivateDataSlot Null => new(IntPtr.Zero);
	public static bool operator ==(VkPrivateDataSlot left, VkPrivateDataSlot right) => left.Handle == right.Handle;
	public static bool operator !=(VkPrivateDataSlot left, VkPrivateDataSlot right) => left.Handle != right.Handle;
	public bool Equals(ref VkPrivateDataSlot other) => Handle == other.Handle;
	public bool Equals(VkPrivateDataSlot other) => Handle == other.Handle;
	public override bool Equals(object obj) => obj is VkPrivateDataSlot handle && Equals(ref handle);
	public override int GetHashCode() => Handle.GetHashCode();
	private string DebuggerDisplay => $"VkPrivateDataSlot [0x{Handle:X}]";
}
...
public partial struct VkCuModuleNVX : IEquatable<VkCuModuleNVX>
{
	...
	public static VkCuModuleNVX Null => new(IntPtr.Zero);
	public static bool operator ==(VkCuModuleNVX left, VkCuModuleNVX right) => left.Handle == right.Handle;
	public static bool operator !=(VkCuModuleNVX left, VkCuModuleNVX right) => left.Handle != right.Handle;
	public bool Equals(ref VkCuModuleNVX other) => Handle == other.Handle;
	public bool Equals(VkCuModuleNVX other) => Handle == other.Handle;
	public override bool Equals(object obj) => obj is VkCuModuleNVX handle && Equals(ref handle);
	public override int GetHashCode() => Handle.GetHashCode();
	private string DebuggerDisplay => $"VkCuModuleNVX [0x{Handle:X}]";
}
...
public partial struct VkCuFunctionNVX : IEquatable<VkCuFunctionNVX>
{
	...
	public static VkCuFunctionNVX Null => new(IntPtr.Zero);
	public static bool operator ==(VkCuFunctionNVX left, VkCuFunctionNVX right) => left.Handle == right.Handle;
	public static bool operator !=(VkCuFunctionNVX left, VkCuFunctionNVX right) => left.Handle != right.Handle;
	public bool Equals(ref VkCuFunctionNVX other) => Handle == other.Handle;
	public bool Equals(VkCuFunctionNVX other) => Handle == other.Handle;
	public override bool Equals(object obj) => obj is VkCuFunctionNVX handle && Equals(ref handle);
	public override int GetHashCode() => Handle.GetHashCode();
	private string DebuggerDisplay => $"VkCuFunctionNVX [0x{Handle:X}]";
}
...
public partial struct VkVideoSessionKHR : IEquatable<VkVideoSessionKHR>
{
	...
	public static VkVideoSessionKHR Null => new(IntPtr.Zero);
	public static bool operator ==(VkVideoSessionKHR left, VkVideoSessionKHR right) => left.Handle == right.Handle;
	public static bool operator !=(VkVideoSessionKHR left, VkVideoSessionKHR right) => left.Handle != right.Handle;
	public bool Equals(ref VkVideoSessionKHR other) => Handle == other.Handle;
	public bool Equals(VkVideoSessionKHR other) => Handle == other.Handle;
	public override bool Equals(object obj) => obj is VkVideoSessionKHR handle && Equals(ref handle);
	public override int GetHashCode() => Handle.GetHashCode();
	private string DebuggerDisplay => $"VkVideoSessionKHR [0x{Handle:X}]";
}
...
public partial struct VkVideoSessionParametersKHR : IEquatable<VkVideoSessionParametersKHR>
{
	...
	public static VkVideoSessionParametersKHR Null => new(IntPtr.Zero);
	public static bool operator ==(VkVideoSessionParametersKHR left, VkVideoSessionParametersKHR right) => left.Handle == right.Handle;
	public static bool operator !=(VkVideoSessionParametersKHR left, VkVideoSessionParametersKHR right) => left.Handle != right.Handle;
	public bool Equals(ref VkVideoSessionParametersKHR other) => Handle == other.Handle;
	public bool Equals(VkVideoSessionParametersKHR other) => Handle == other.Handle;
	public override bool Equals(object obj) => obj is VkVideoSessionParametersKHR handle && Equals(ref handle);
	public override int GetHashCode() => Handle.GetHashCode();
	private string DebuggerDisplay => $"VkVideoSessionParametersKHR [0x{Handle:X}]";
}
